use crate::script::{Variable, VariableDataType, VariableMemoryType};
...
impl VariableAst {
    pub fn new(var: &Variable) -> VariableAst {
        match (&var.memory_type, &var.data_type) {
            (VariableMemoryType::InternalConstant, VariableDataType::Int) => {
                VariableAst::InternalConstantInt(InternalConstantInt::new(var.address))
            }
            (VariableMemoryType::LongtermAccess, VariableDataType::Int) => {
                VariableAst::LongtermAccessInt(LongtermAccessInt::new(var.address))
            }
            (VariableMemoryType::LongtermAccess, VariableDataType::Float) => {
                VariableAst::LongtermAccessFloat(LongtermAccessFloat::new(var.address))
            }
            (VariableMemoryType::LongtermAccess, VariableDataType::Bool) => {
                VariableAst::LongtermAccessBool(LongtermAccessBool::new(var.address))
            }
            (VariableMemoryType::RandomAccess, VariableDataType::Int) => {
                VariableAst::RandomAccessInt(RandomAccessInt::new(var.address))
            }
            (VariableMemoryType::RandomAccess, VariableDataType::Float) => {
                VariableAst::RandomAccessFloat(RandomAccessFloat::new(var.address))
            }
            (VariableMemoryType::RandomAccess, VariableDataType::Bool) => {
                VariableAst::RandomAccessBool(RandomAccessBool::new(var.address))
            }
