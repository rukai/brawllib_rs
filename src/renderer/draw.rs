...

    {
        ...
        if render_ecb {
            ...
            for extent in &subaction_extent.extents {
                ...
                //let vertices_array = [
                //    Vertex { _pos: [0.0, extent.up,   extent.left,  1.0], _color },
                //    Vertex { _pos: [0.0, extent.down, extent.left,  1.0], _color },
                //    Vertex { _pos: [0.0, extent.up,   extent.right, 1.0], _color },
                //    Vertex { _pos: [0.0, extent.down, extent.right, 1.0], _color },
                //];
                //let indices_array: [u16; 6] = [
                //    0, 1, 2,
                //    1, 2, 3,
